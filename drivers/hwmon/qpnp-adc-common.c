...
#define ADC_TEMP_NEGTIVE_FIVE			75
#define ADC_TEMP_POSITIVE_FORTY_NINE	20
#endif
...
static const struct qpnp_vadc_map_pt adcmap_btm_threshold_0_45[] = {	/*0~45  pullup Rs1:77k;Rs2:22.1k*/
	{ -400,	 1724},
	{ -390,	 1719},
	{ -380,	 1714},
	{ -370,	 1709},
...
static struct qpnp_vadc_map_pt adcmap_btm_threshold_0_60[] = {		/*0~60  pullup Rs1:39k;Rs2:1.2k*/
	{ -400,	 1760},
	{ -390,	 1758},
	{ -380,	 1755},
	{ -370,	 1752},
...
#if defined(CONFIG_BOARD_HELEN)
static const struct qpnp_vadc_map_pt adcmap_threshold_negtive_5_positive_49[] = {	/*Only for K81:-5degc~49degc*/
	{ -400,	 1743},
	{ -390,	 1739},
	{ -380,	 1735},
	{ -370,	 1731},
...
unsigned int batt_hot_threshold;
unsigned int batt_cold_threshold;
...
#if defined(CONFIG_BOARD_HELEN)
	else if (batt_hot_threshold == ADC_TEMP_POSITIVE_FORTY_NINE
			&& batt_cold_threshold == ADC_TEMP_NEGTIVE_FIVE) {
		return qpnp_adc_map_temp_voltage(
				adcmap_threshold_negtive_5_positive_49,
				ARRAY_SIZE(adcmap_threshold_negtive_5_positive_49),
				bat_voltage,
				&adc_chan_result->physical);
	}
#endif
