 ...
 */
 ...
 /*************** Definitions ******************/
#define ZTE_RPR521_SENSORS_CLASS_DEV	/*xym add*/
#define ZTE_RPR521_CALIBRATION	/*xym add*/
#define ZTE_RPR521_PINCTRL	/*xym add for pinctrl, 20150602*/

/* GENERAL */
#define RPR521_DRV_NAME "rpr521"
#define RPR0521_DRIVER_VERSION "1.0"
#if defined(CONFIG_BOARD_MAX)	/*N9521*/
/*#elif defined (CONFIG_BOARD_MAX)*/	/*N9521*/
#define THRES_TOLERANCE		40
#define THRES_DEFAULT_DIFF		30
#define PS_CROSSTALK 600
#else
#define THRES_TOLERANCE 40		/*15 */	/*I think this is a proper value. It should not be too big.*/
#define THRES_DEFAULT_DIFF 40	/*30*/
#define PS_CROSSTALK 600	/*xym add temp, just guess.*/
#endif
...
/* SETTINGS */
/*Andy 2012.6.6: it was (1000) previously.
But I don't think the customer need als data with such accuracy.*/
#define CUT_UNIT					(1)/*(10)*/
...
/*Set high gain value to acquire high accuracy*/
...
/*Customer should change the threshold value according to their mechanical design and measured data*/
#define PS_ALS_SET_PS_TH			(160)
#define PS_ALS_SET_PS_TL			(130)	/*Changed from (0x000)*/
/*Compare with ALS_DATA0. ALS_Data equals 0.192*ALS_DATA0 roughly. Usually not used.*/
#define PS_ALS_SET_ALS_TH			(2000)
#define PS_ALS_SET_ALS_TL			(0x0000)	/*Usually not used.*/
/*Andy Mi: Changed from 125 to 100. I have no idea why it is 125 previously.*/
...
struct ALS_PS_DATA {
	...
	unsigned int ps_direction;		/* 0 = near; 1 = far */
