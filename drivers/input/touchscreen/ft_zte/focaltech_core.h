...
#define FTS_CTL_IIC
#if defined(CONFIG_BOARD_ELDEN) || defined(CONFIG_BOARD_SAPPHIRE) || defined(CONFIG_BOARD_HELEN)
...
struct fts_psensor_platform_data {
	...
	bool tp_psensor_enable; /*true---sneed to enable*/
...
extern int fts_ctpm_auto_upgrade_select(struct i2c_client *client);
